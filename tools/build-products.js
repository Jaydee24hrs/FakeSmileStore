...
function renderProduct(p) {
    ...
    h = replaceOnce(h, '<span class="pd-meta-value" id="pd-sku">FS-&middot;&middot;&middot;</span>', '<span class="pd-meta-value" id="pd-sku">FS-' + esc(p.id.toUpperCase()) + '</span>', 'pd-sku');
    h = replaceOnce(h, '<span class="pd-meta-value" id="pd-meta-cat">&middot;&middot;&middot;</span>', '<span class="pd-meta-value" id="pd-meta-cat">' + esc(p.category) + '</span>', 'pd-meta-cat');
    h = replaceOnce(h, '<span class="pd-meta-value" id="pd-meta-tag">&middot;&middot;&middot;</span>', '<span class="pd-meta-value" id="pd-meta-tag">' + esc(p.tag) + '</span>', 'pd-meta-tag');
